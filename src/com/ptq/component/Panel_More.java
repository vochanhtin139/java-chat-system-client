...
import com.ptq.emoji.Model_Emoji;
import com.ptq.event.PublicEvent;
import com.ptq.main.Main;
...
import com.ptq.swing.WrapLayout;
...
public class Panel_More extends javax.swing.JPanel {
    ...
    private JButton getButtonFile() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/ptq/icon/link.png")));
    ...
    private JButton getButton(Model_Emoji data) {
        ...
        String currentTimeString = currentTime.format(formatter);
                Model_Send_Message message = new Model_Send_Message(MessageType.EMOJI, Service.getInstance().getUser().getUserID(), user.getUserID(), data.getId() + "",currentTimeString);
                sendMessage(message);

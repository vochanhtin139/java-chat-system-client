...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/ptq/icon/tick.png")));
        }
    }
    ...
    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/ptq/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.ptq.swing.JIMSendTextPane();
    ...
    private com.ptq.swing.JIMSendTextPane txt;
